...
// Component
export function CourseCard({ id, title, instructor, progress, accent, showProgress = true }: CourseCardProps) {
  return (
...
// Skeleton
export function CourseCardSkeleton({ count = 4, showProgress = true }: { count?: number; showProgress?: boolean }) {
  return (
    <>
