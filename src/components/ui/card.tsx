...
function CardTitle({ className, ...props }: CardPartProps) {
  return (
    <div
...
function CardDescription({ className, ...props }: CardPartProps) {
  return (
    <div
...
function CardAction({ className, ...props }: CardPartProps) {
  return (
    <div
